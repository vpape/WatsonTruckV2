...
namespace WatsonTruckV2.Models
{
    ...
    public partial class WatsonTruckEntities : DbContext
    {
        ...
        public virtual int DeleteSpouseAndDependent(Nullable<int> memberid)
        {
            var memberidParameter = memberid.HasValue ?
                new ObjectParameter("memberid", memberid) :
                new ObjectParameter("memberid", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("DeleteSpouseAndDependent", memberidParameter);
        }
